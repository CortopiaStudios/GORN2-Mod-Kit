...
3. Download the Mod Kit project by either cloning the repository using [git](https://git-scm.com/) or download it a `.zip` file from the dropdown menu **Code → Download ZIP** at the top of this page and unzip the file.
