	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				half2 texCoord670 = i.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				half3 tex2DNode668 = UnpackScaleNormal( tex2D( _TextureSample1, texCoord670 ), 2.0 );
				...
				half3 worldNormal750 = normalize( float3(dot(tanToWorld0,tanNormal750), dot(tanToWorld1,tanNormal750), dot(tanToWorld2,tanNormal750)) );
				half smoothstepResult782 = smoothstep( 0.5 , 2.0 , ( ( worldNormal750.y + ( tex2DNode668.g * 0.5 ) ) * 2.0 ));
				half temp_output_724_0 = ( i.ase_color.a * _Erode );
				half temp_output_470_0 = saturate( ( 1.0 - temp_output_724_0 ) );
				float2 uv_Main = i.ase_texcoord1.xy * _Main_ST.xy + _Main_ST.zw;
				half4 tex2DNode533 = tex2D( _Main, uv_Main );
				half A563 = tex2DNode533.r;
				half temp_output_610_0 = ( saturate( ( ( tex2DNode533.g - temp_output_470_0 ) / ( 1.0 - tex2DNode533.r ) ) ) * A563 );
				half Erosion819 = temp_output_610_0;
				half4 appendResult841 = (half4(_SpecColor.r , _SpecColor.g , _SpecColor.b , ( _SpecColor.a * Erosion819 )));
				half4 temp_output_644_0 = ( saturate( ( saturate( ( saturate( ( saturate( smoothstepResult782 ) - ( ( 1.0 - _Spec ) + 0.23 ) ) ) / temp_output_470_0 ) ) * _Spec ) ) * appendResult841 );
				half4 GradSpec559 = temp_output_644_0;
				half4 break813 = GradSpec559;
				half4 appendResult855 = (half4(break813.x , break813.y , break813.z , 0.0));
				half Translucency690 = ( 1.0 - saturate( ( tex2DNode533.b * 1.0 ) ) );
				half Erodeval744 = temp_output_724_0;
				half clampResult747 = clamp( ( ( 1.0 - Erodeval744 ) * 1.0 ) , 0.0 , 1.0 );
				half temp_output_781_0 = saturate( ( Translucency690 * _Translucency * clampResult747 ) );
				half temp_output_862_0 = saturate( temp_output_781_0 );
				half clampResult773 = clamp( temp_output_862_0 , 0.1 , 0.2 );
				half4 temp_cast_0 = (clampResult773).xxxx;
				half temp_output_771_0 = saturate( A563 );
				half4 break716 = saturate( ( ( saturate( ( ( A563 * _BaseColor ) - temp_cast_0 ) ) + ( ( _Lucencycol * temp_output_862_0 ) * ( temp_output_771_0 * 1.0 ) ) ) * temp_output_610_0 ) );
				half BaseAlpha799 = _BaseColor.a;
				half LucencyAlpha800 = temp_output_781_0;
				half temp_output_822_0 = saturate( ( saturate( ( break813.x + break813.y + break813.z ) ) * saturate( Erosion819 ) ) );
				half SpecBaseAlpha831 = saturate( ( saturate( ( BaseAlpha799 - temp_output_822_0 ) ) + temp_output_822_0 ) );
				half temp_output_835_0 = saturate( ( temp_output_610_0 * saturate( ( ( BaseAlpha799 - ( LucencyAlpha800 * 5.0 ) ) + SpecBaseAlpha831 ) ) ) );
				half LucencyAlphaAdjust874 = _Lucencycol.a;
				half temp_output_866_0 = ( saturate( ( ( 1.0 - LucencyAlphaAdjust874 ) * temp_output_835_0 ) ) * ( LucencyAlpha800 * 1.0 ) );
				half TranslucencySlider899 = _Translucency;
				half4 appendResult715 = (half4(break716.r , break716.g , break716.b , saturate( ( ( ( ( temp_output_835_0 * 1.0 ) + temp_output_866_0 ) * 1.0 ) - ( saturate( ( temp_output_866_0 * 10.0 ) ) * TranslucencySlider899 ) ) )));
...
Node;AmplifyShaderEditor.SamplerNode;533;3851.148,3462.446;Inherit;True;Property;_Main;Main;2;0;Create;True;0;0;0;False;0;False;-1;adb623358578bd843b134582a3e26712;0c5673fc311b59042a968c47561bf126;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;643;4131.375,4691.313;Inherit;False;Property;_SpecColor;SpecColor;5;1;[HDR];Create;True;0;0;0;False;0;False;27.3029,1.748462,1.748462,0;0.3411765,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;774;5278.658,1679.337;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;697;4363.584,1304.358;Inherit;False;Property;_Lucencycol;Lucencycol;4;1;[HDR];Create;True;0;0;0;False;0;False;0.6509434,0,0.4581906,1;0.2156863,0.003921565,0.007718311,0.9647059;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;567;4097,2416.982;Inherit;False;Property;_BaseColor;BaseColor;3;1;[HDR];Create;True;0;0;0;False;0;False;0.3301887,0,0,1;0.245283,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;558;3045.472,4561.779;Inherit;False;Property;_Spec;Spec;1;0;Create;True;0;0;0;False;0;False;1;0.644;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;670;2151.872,3869.959;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;480;2861.24,3422.815;Inherit;False;Property;_Erode;Erode;0;0;Create;True;0;0;0;False;0;False;0;0.921;0;0.98;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;735;3078.837,1676.156;Inherit;False;Property;_Translucency;Translucency;7;0;Create;True;0;0;0;False;0;False;1;0.751;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;714;9664.277,3335.634;Half;False;True;-1;2;ASEMaterialInspector;100;5;vfx_bloodsplash;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;2;False;;True;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;3;False;;True;False;0;False;;0;False;;True;1;RenderType=Transparent=RenderType;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;559;5648.177,4670.461;Inherit;False;GradSpec;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;895;8160.12,3791.188;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;876;6732.488,3651.843;Inherit;False;874;LucencyAlphaAdjust;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;470;3459.434,3324.368;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;923;5437.167,4893.057;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;924;4606.694,4167.681;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;833;6352.868,3935.701;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;832;6050.756,4127.568;Inherit;True;831;SpecBaseAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;873;7251.037,3782.502;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;565;4228.742,2158.673;Inherit;True;563;A;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;775;5030.825,1779.628;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;772;5092.689,2049.491;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
WireConnection;923;0;840;3
WireConnection;924;0;556;0
...
ASEEND*/
//CHKSM=257BA9EA08CB92DAB62D2F5D8D0CFD387F3B0930