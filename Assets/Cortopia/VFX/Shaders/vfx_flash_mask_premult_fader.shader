...
Shader "vfx_flash_mask_premult_fader"
{
	Properties
	{
		_Mask("Mask", 2D) = "white" {}
		...
		_DistFade("DistFade", Range( -1 , 1)) = 1
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_543_0 = distance( _WorldSpaceCameraPos , WorldPosition );
				float smoothstepResult550 = smoothstep( 0.4 , 0.7 , ( _DistFade * temp_output_543_0 ));
				float temp_output_546_0 = saturate( smoothstepResult550 );
				float4 break529 = saturate( saturate( ( _Color0 * saturate( ( _ContrastBoost * ( ( ( saturate( ( tex2DNode463.r * temp_output_496_0 ) ) * (( _ErodemanualvertexcolA )?( saturate( i.ase_color.a ) ):( _Erode )) ) - ( 1.0 - (( _ErodemanualvertexcolA )?( saturate( i.ase_color.a ) ):( _Erode )) ) ) / (( _ErodemanualvertexcolA )?( saturate( i.ase_color.a ) ):( _Erode )) ) ) ) * temp_output_546_0 ) ) );
				float4 appendResult530 = (float4(break529.r , break529.g , break529.b , ( break529.a * ( _Color0.a * i.ase_color.a * temp_output_546_0 ) )));
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;486;-1682.828,1417.5;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;528;94.46069,1559.056;Float;False;True;-1;2;ASEMaterialInspector;100;5;vfx_flash_mask_premult_fader;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;3;1;False;;10;False;;0;1;False;;10;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;2;False;;True;True;True;True;True;False;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;RenderType=Transparent=RenderType;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
...
Node;AmplifyShaderEditor.DistanceOpNode;543;-1505.485,2077.09;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;530;-654.3754,1702.795;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;547;-709.8088,2044.851;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceCameraPos;542;-1786.872,1909.495;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;540;-1744.549,2109.176;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.OneMinusNode;548;-1046.552,2212.046;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;546;-1081.874,2041.319;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;549;-1201.971,2023.642;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;541;-1800.813,2316.837;Inherit;False;Property;_DistFade;DistFade;12;0;Create;True;0;0;0;False;0;False;1;1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;544;-1368.666,2258.02;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;550;-1203.149,2208.497;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.4;False;2;FLOAT;0.7;False;1;FLOAT;0
...
WireConnection;549;0;543;0
WireConnection;549;1;541;0
WireConnection;544;0;541;0
WireConnection;544;1;543;0
WireConnection;550;0;544;0
ASEEND*/
//CHKSM=7E203D114D343B7892FDDD97783428836C8561E4