...
Shader "vfx_flash_mask_premult_vcol"
{
	Properties
	{
		_Mask("Mask", 2D) = "white" {}
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 appendResult539 = (float3(i.ase_color.r , i.ase_color.g , i.ase_color.b));
				...
				float3 break529 = saturate( saturate( ( (( _VertexColored )?( appendResult539 ):( appendResult541 )) * saturate( ( _ContrastBoost * ( ( ( saturate( ( tex2DNode463.r * temp_output_496_0 ) ) * (( _ErodemanualvertexcolA )?( saturate( i.ase_color.a ) ):( _Erode )) ) - ( 1.0 - (( _ErodemanualvertexcolA )?( saturate( i.ase_color.a ) ):( _Erode )) ) ) / (( _ErodemanualvertexcolA )?( saturate( i.ase_color.a ) ):( _Erode )) ) ) ) ) ) );
				float4 appendResult530 = (float4(break529.x , break529.y , break529.z , ( 0.0 * ( _Color0.a * i.ase_color.a ) )));
...
Node;AmplifyShaderEditor.SamplerNode;464;-5036.375,826.3401;Inherit;True;Property;_FlashTex;FlashTex;1;0;Create;True;0;0;0;False;0;False;-1;None;ccf2cb8e2e8fb7c468edf082cd83ec3a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;478;-2326.971,676.4628;Inherit;False;Property;_Color0;Color 0;8;1;[HDR];Create;True;0;0;0;False;0;False;0.4669811,0.5426843,1,1;1.059274,0.9312048,0.8052958,0.7019608;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;528;94.46069,1559.056;Float;False;True;-1;2;ASEMaterialInspector;100;5;vfx_flash_mask_premult_vcol;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;3;1;False;;10;False;;0;1;False;;10;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;2;False;;True;True;True;True;True;False;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;RenderType=Transparent=RenderType;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;533;-1996.433,1059.112;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;538;-1709.473,827.4994;Inherit;False;Property;_VertexColored;VertexColored;12;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;196;-2732.515,1361.849;Inherit;False;Property;_ContrastBoost;ContrastBoost;7;0;Create;True;0;0;0;False;0;False;2.67783;2.64;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;547;-2348.021,1441.347;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;545;-2483.222,1120.247;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;546;-2250.521,1251.547;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;543;-2838.125,1061.747;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;545;0;543;3
WireConnection;546;0;543;3
ASEEND*/
//CHKSM=36F85F2D30DD5CD92B7A942F17A8C9E82C4C48D9