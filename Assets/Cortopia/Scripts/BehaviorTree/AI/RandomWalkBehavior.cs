...
{
    public class RandomWalkBehavior : BehaviorTreeBase
    {
        [Space]
        [SerializeField]
        ...
        [Header("Target")]
        [SerializeField]
        private BoundValue<float> minTargetDistance = new(2);
        [SerializeField]
        private BoundValue<float> maxTargetDistance = new(8);
        [SerializeField]
        private BoundValue<float> minTurnAngle = new(15);
        [SerializeField]
        private BoundValue<float> maxTurnAngle = new(45);
        [SerializeField]
        private BoundValue<float> distanceDifferenceThreshold = new(1);
        [SerializeField]
