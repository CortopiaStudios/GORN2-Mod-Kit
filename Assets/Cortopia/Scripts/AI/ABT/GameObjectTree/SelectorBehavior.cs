...
{
    [AddComponentMenu("BehaviorTree/Group/SelectorBehavior")]
    public class SelectorBehavior : BehaviorTreeGroupBase
    {
        [SerializeField]
        ...
        {
            return this.WithSubTrees(new BtSelector(this.DebugName, this.mode));
        }
    }
}