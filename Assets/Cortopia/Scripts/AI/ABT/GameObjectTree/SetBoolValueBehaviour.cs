...
{
    [AddComponentMenu("BehaviorTree/Common/SetBoolValueBehavior")]
    public class SetBoolValueBehavior : BehaviorTreeBase
    {
        [SerializeField]
        private WritableBoundValue<bool> value;
        [SerializeField]
        private BoundValue<bool> newValue;
