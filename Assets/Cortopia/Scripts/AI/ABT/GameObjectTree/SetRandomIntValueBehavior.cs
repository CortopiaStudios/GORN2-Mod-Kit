...
{
    [AddComponentMenu("BehaviorTree/Common/SetRandomIntValueBehavior")]
    public class SetRandomIntValueBehavior : BehaviorTreeBase
    {
        [SerializeField]
        private WritableBoundValue<int> value;
        [SerializeField]
        [Tooltip("Inclusive lower boundary")]
        private BoundValue<int> minValue;
        [SerializeField]
        [Tooltip("Exclusive upper boundary")]
