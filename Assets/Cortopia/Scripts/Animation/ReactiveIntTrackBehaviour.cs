...
{
    [Serializable]
    public class ReactiveIntTrackBehaviour : PlayableBehaviour
    {
        public WritableBoundValue<int> writeTarget;
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            for (int i = 0; i < this._activeClips.Length; i++)
            {
                ...
                IntPlayableBehavior behaviour = ((ScriptPlayable<IntPlayableBehavior>) playable.GetInput(i)).GetBehaviour();
