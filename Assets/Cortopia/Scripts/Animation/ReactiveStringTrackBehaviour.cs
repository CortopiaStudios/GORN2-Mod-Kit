...
{
    [Serializable]
    public class ReactiveStringTrackBehaviour : PlayableBehaviour
    {
        public WritableBoundValue<string> writeTarget;
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            for (int i = 0; i < this._activeClips.Length; i++)
            {
                ...
                StringPlayableBehavior behaviour = ((ScriptPlayable<StringPlayableBehavior>) playable.GetInput(i)).GetBehaviour();
