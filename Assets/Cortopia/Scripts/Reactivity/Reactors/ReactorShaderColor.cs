...
namespace Cortopia.Scripts.Reactivity.Reactors
{
    ...
    public class ReactorShaderColor : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private BoundValue<Color> value;
        ...
        {
            this._subscribe &= this.value.Reactive.OnValue(f => this._renderer.materials[this.materialSubIndex].SetColor(this._shaderProperty, f));
        }
