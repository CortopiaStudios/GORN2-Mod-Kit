...
{
    // OnCollisionStayEvent allows the user to listen to collision events on only the children colliders on this component or
    ...
    public class OnCollisionStayEvent : MonoBehaviour
    {
        ...
        [Space]
        [SerializeField]
        private UnityEvent<Collision> collisionStay = new();
    }
}