...
Shader "Cortopia/ase_bleeding_edge"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult123 = lerp( tex2DNode1 , ( color125 * saturate( ( ( tex2D( _BloodMaskR, uv_TexCoord130 ).r + tex2D( _BloodMaskR, uv_TexCoord163 ).r ) + 0.5 ) ) ) , i.vertexColor.b);
			...
			o.Emission = staticSwitch3_g9.xyz;
				...
				float staticSwitch3_g10 = i.vertexColor.r;
			#else
				float staticSwitch3_g10 = 0.0;
			#endif
			#ifdef _DiffuseOnlyMode
				float staticSwitch8_g9 = 0.0;
			#else
				float staticSwitch8_g9 = ( staticSwitch3_g10 * 0.95 );
			#endif
...
Node;AmplifyShaderEditor.SamplerNode;44;-518.3013,-272.1273;Inherit;True;Property;_Normal;Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;b7d3ed8a1f501d84395d57ae6f80e5da;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;114;-572.645,255.9983;Inherit;False;ase_function_forcegrab;5;;11;28a011451f93f55429710d8f45046efa;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;71;-644.1626,383.9876;Inherit;False;ase_function_metallic;3;;10;6f2bdb1e1a920ec409d1c604a9c39837;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VertexColorNode;118;-846.979,194.7908;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;128;-1918.047,403.2535;Inherit;True;Property;_BloodMaskR;BloodMask(R);2;0;Create;True;0;0;0;False;0;False;-1;None;5657507ec4511ef43a15e0e101373dad;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;162;-1919.137,599.9888;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;128;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=5EC7375FFBAC3EFE187F6BA69C53F49771434F66