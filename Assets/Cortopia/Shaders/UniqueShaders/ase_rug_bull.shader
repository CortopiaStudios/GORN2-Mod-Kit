	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 texCoord2 = i.ase_texcoord1.xy * appendResult19 + appendResult34;
				
				
				finalColor = tex2D( _Texture2x1, texCoord2 );
				return finalColor;
			}
			ENDCG
		}
...
ASEEND*/
//CHKSM=2457F7A8B4C7D30E13835232828C93D27E4DBD61