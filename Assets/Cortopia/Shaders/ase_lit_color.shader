	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float fresnelNdotV11_g1 = dot( WorldNormal, worldViewDir );
				...
				#endif
				float3 temp_cast_1 = (staticSwitch9).xxx;
