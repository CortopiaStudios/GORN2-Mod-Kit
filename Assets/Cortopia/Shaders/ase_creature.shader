	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 color1_g24 = IsGammaSpace() ? float4(0.6226415,0.1795018,0.1204165,0) : float4(0.3456162,0.02707354,0.01348848,0);
				float2 uv_MaskTexture = IN.ase_texcoord9.xy * _MaskTexture_ST.xy + _MaskTexture_ST.zw;
				float4 tex2DNode56 = tex2D( _MaskTexture, uv_MaskTexture );
				float4 color2_g24 = IsGammaSpace() ? float4(0.5188679,0.06118724,0.07892682,0) : float4(0.2319225,0.005018505,0.007057911,0);
				float2 texCoord54 = IN.ase_texcoord9.xy * float2( 5,5 ) + float2( 0,0 );
				float temp_output_61_0 = ( tex2DNode56.r + ( tex2DNode56.r * tex2D( _BreakUpNoise, texCoord54 ).r ) );
				float smoothstepResult103 = smoothstep( 0.7 , 0.8 , temp_output_61_0);
				float4 lerpResult57 = lerp( tex2DNode1 , ( ( color1_g24 * tex2DNode56.r ) + ( color2_g24 * tex2DNode56.a ) ) , smoothstepResult103);
				...
				#endif
				float clampResult92 = clamp( tex2DNode56.a , 0.1 , 0.75 );
				...
				float staticSwitch3_g6 = IN.ase_color.r;
				#else
		...
		Pass
		{
			...
			)
			{
				...
				float2 uv_Albedo_Smoothness = IN.ase_texcoord8.xy * _Albedo_Smoothness_ST.xy + _Albedo_Smoothness_ST.zw;
				float4 tex2DNode1 = tex2D( _Albedo_Smoothness, uv_Albedo_Smoothness );
				float4 color1_g24 = IsGammaSpace() ? float4(0.6226415,0.1795018,0.1204165,0) : float4(0.3456162,0.02707354,0.01348848,0);
				float2 uv_MaskTexture = IN.ase_texcoord8.xy * _MaskTexture_ST.xy + _MaskTexture_ST.zw;
				float4 tex2DNode56 = tex2D( _MaskTexture, uv_MaskTexture );
				float4 color2_g24 = IsGammaSpace() ? float4(0.5188679,0.06118724,0.07892682,0) : float4(0.2319225,0.005018505,0.007057911,0);
				float2 texCoord54 = IN.ase_texcoord8.xy * float2( 5,5 ) + float2( 0,0 );
				float temp_output_61_0 = ( tex2DNode56.r + ( tex2DNode56.r * tex2D( _BreakUpNoise, texCoord54 ).r ) );
				float smoothstepResult103 = smoothstep( 0.7 , 0.8 , temp_output_61_0);
				float4 lerpResult57 = lerp( tex2DNode1 , ( ( color1_g24 * tex2DNode56.r ) + ( color2_g24 * tex2DNode56.a ) ) , smoothstepResult103);
				float4 temp_output_10_0_g5 = lerpResult57;
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 tex2DNode56 = tex2D( _MaskTexture, uv_MaskTexture );
				float4 color2_g24 = IsGammaSpace() ? float4(0.5188679,0.06118724,0.07892682,0) : float4(0.2319225,0.005018505,0.007057911,0);
				float2 texCoord54 = IN.ase_texcoord3.xy * float2( 5,5 ) + float2( 0,0 );
				float temp_output_61_0 = ( tex2DNode56.r + ( tex2DNode56.r * tex2D( _BreakUpNoise, texCoord54 ).r ) );
				float smoothstepResult103 = smoothstep( 0.7 , 0.8 , temp_output_61_0);
				float4 lerpResult57 = lerp( tex2DNode1 , ( ( color1_g24 * tex2DNode56.r ) + ( color2_g24 * tex2DNode56.a ) ) , smoothstepResult103);
				float4 temp_output_10_0_g5 = lerpResult57;
...
Node;AmplifyShaderEditor.LerpOp;57;277.2086,-640.719;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-296.341,-785.1157;Inherit;True;Property;_Albedo_Smoothness;Albedo_Smoothness;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;-353.9915,-471.3955;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;59;-102.9098,-570.3452;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;88;314.2617,-413.9068;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;70;521.1103,-413.9432;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;103;-209.7279,-28.77028;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.7;False;2;FLOAT;0.8;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;92;-207.3577,-209.2518;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.1;False;2;FLOAT;0.75;False;1;FLOAT;0
...
WireConnection;57;2;103;0
WireConnection;71;1;54;0
WireConnection;64;0;131;0
WireConnection;64;1;56;1
WireConnection;63;0;131;3
...
WireConnection;133;1;42;0
WireConnection;133;2;109;14
WireConnection;133;4;109;15
WireConnection;133;5;109;16
ASEEND*/
//CHKSM=C71E588E685235057A6967D98A9F48C1871EC73F