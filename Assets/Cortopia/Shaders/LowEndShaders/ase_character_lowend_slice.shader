...
Shader "Cortopia/_LowEnd/ase_character_lowend_slice"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			v2f VertexFunction (appdata v  ) {
				...
				#endif
				float3 vertexValue = SkinnedPosition156;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
				...
				#endif
				v.vertex.w = 1;
				v.normal = SkinnedNormal155;
				v.tangent = SkinnedTangent153;
				...
				) : SV_Target
			{
				...
				float4 tex2DNode97 = tex2D( _MaskTexture, TexCoord154 );
				float Bruises94 = tex2DNode97.b;
				float BruiseBreakupMask106 = tex2D( _BloodCutBruiseMask, ( TexCoord154 * float2( 20,20 ) ) ).b;
				...
				float BloodEdgeMask104 = tex2D( _BloodCutBruiseMask, ( TexCoord154 * 10.0 ) ).r;
				...
				float CutsBreakupMask206 = tex2D( _BloodCutBruiseMask, ( TexCoord154 * 30.0 ) ).r;
				float CutMaskLerp111 = step( ( Cut95 + ( Cut95 * ( CutsBreakupMask206 * 0.1 ) ) ) , 0.86 );
				float4 lerpResult142 = lerp( Flesh_Diffuse127 , lerpResult129 , CutMaskLerp111);
				
				float dotResult3_g21 = dot( WorldNormal , worldViewDir );
				float4 color11_g21 = IsGammaSpace() ? float4(0.682353,0.6941177,1,0) : float4(0.4232678,0.4396573,1,0);
				...
				o.Emission = ( ( saturate( ( ( ( 1.0 - dotResult3_g21 ) - 0.45 ) * 5.0 ) ) * color11_g21 ) * saturate( _Telekinesis_Int ) ).rgb;
				#if defined(_SPECULAR_SETUP)
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float dotResult3_g21 = dot( ase_worldNormal , ase_worldViewDir );
				float4 color11_g21 = IsGammaSpace() ? float4(0.682353,0.6941177,1,0) : float4(0.4232678,0.4396573,1,0);
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;156;192.3359,-788.1425;Inherit;False;SkinnedPosition;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;165;-4070.134,-427.0233;Inherit;False;154;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;169;-3942.064,-689.9829;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;171;-3918.73,46.04584;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;166;-4137.16,-49.88087;Inherit;False;154;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;172;-4117.548,62.18051;Inherit;False;Constant;_Float1;Float 1;8;0;Create;True;0;0;0;False;0;False;10;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;85;-582.7881,147.2286;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;83;-865.2611,73.00092;Inherit;False;78;Smoothness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;82;-1059.283,170.3199;Inherit;False;112;BloodWet;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;200;-833.5662,284.2805;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;201;-1129.754,309.1939;Inherit;False;93;BloodDry;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;170;-4110.853,-689.9694;Inherit;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;0;False;0;False;20;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;167;-4176.535,222.5768;Inherit;False;154;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;108;-4193.285,310.0167;Inherit;False;Constant;_BruiseTiling;BruiseTiling;7;0;Create;True;0;0;0;False;0;False;20,20;20,20;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;207;-3976.071,472.4517;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;208;-4178.87,430.8515;Inherit;False;154;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;211;-4159.491,523.5527;Inherit;False;Constant;_Float2;Float 2;7;0;Create;True;0;0;0;False;0;False;30;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;111;-2146.114,-176.3813;Inherit;False;CutMaskLerp;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;162;-151.3362,138.367;Inherit;False;156;SkinnedPosition;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;163;-150.621,281.2696;Inherit;False;153;SkinnedTangent;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;164;-151.4883,207.943;Inherit;False;155;SkinnedNormal;1;0;OBJECT;;False;1;FLOAT3;0
