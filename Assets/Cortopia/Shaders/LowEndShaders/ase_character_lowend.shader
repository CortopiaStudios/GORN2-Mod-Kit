...
Shader "Cortopia/_LowEnd/ase_character_lowend"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			v2f VertexFunction (appdata v  ) {
				...
				float3 SkinnedPosition172 = v.vertex.xyz;
				
				float3 SkinnedNormal171 = v.normal;
				
				float3 SkinnedTangent170 = v.tangent.xyz;
				...
				#endif
				float3 vertexValue = SkinnedPosition172;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
				...
				#endif
				v.vertex.w = 1;
				v.normal = SkinnedNormal171;
				v.tangent = float4( SkinnedTangent170 , 0.0 );
				...
				) : SV_Target
			{
				...
				float2 texCoord173 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 TexCoord169 = texCoord173;
				float4 tex2DNode123 = tex2D( _Flesh, ( 20.0 * TexCoord169 ) );
				float4 Flesh_Diffuse127 = tex2DNode123;
				float4 tex2DNode76 = tex2D( _Albedo_Smoothness, TexCoord169 );
				float4 Diffuse77 = tex2DNode76;
				float4 color68 = IsGammaSpace() ? float4(0.7529412,0.2705882,0,0) : float4(0.5271152,0.05951123,0,0);
				float4 BruiseColor80 = color68;
				float4 tex2DNode97 = tex2D( _MaskTexture, TexCoord169 );
				float Bruises94 = tex2DNode97.b;
				float BruiseBreakupMask106 = tex2D( _BloodCutBruiseMask, ( TexCoord169 * float2( 20,20 ) ) ).b;
				...
				float BloodEdgeMask104 = tex2D( _BloodCutBruiseMask, ( TexCoord169 * 10.0 ) ).r;
				float temp_output_62_0 = ( BloodDry93 + ( BloodDry93 * BloodEdgeMask104 ) );
				float BloodLerp115 = saturate( step( 0.7 , temp_output_62_0 ) );
				float clampResult184 = clamp( BloodLerp115 , 0.0 , 0.97 );
				float4 lerpResult129 = lerp( lerpResult141 , ( color1_g2 + ( color2_g2 * BloodWet112 ) ) , clampResult184);
				float Cut95 = tex2DNode97.g;
				float CutsBreakupMask187 = tex2D( _BloodCutBruiseMask, ( TexCoord169 * 30.0 ) ).r;
				float CutMaskLerp111 = step( ( Cut95 + ( Cut95 * CutsBreakupMask187 ) ) , 0.86 );
				float4 lerpResult142 = lerp( Flesh_Diffuse127 , lerpResult129 , CutMaskLerp111);
				...
				float FleshSmoothness126 = tex2DNode123.a;
				float Smoothness78 = tex2DNode76.a;
				float lerpResult85 = lerp( Smoothness78 , ( BloodWet112 * 0.95 ) , ( BloodWet112 * BloodDry93 ));
				float lerpResult86 = lerp( FleshSmoothness126 , lerpResult85 , CutMaskLerp111);
				
				o.Albedo = lerpResult142.rgb;
				...
				o.Emission = ( ( saturate( ( ( ( 1.0 - dotResult3_g4 ) - 0.45 ) * 5.0 ) ) * color11_g4 ) * saturate( _Telekinesis_Int ) ).rgb;
					...
					o.Metallic = 0;
				#endif
				o.Smoothness = saturate( lerpResult86 );
				o.Occlusion = 1;
				o.Alpha = 1;
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float2 texCoord173 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 TexCoord169 = texCoord173;
				float4 tex2DNode123 = tex2D( _Flesh, ( 20.0 * TexCoord169 ) );
				float4 Flesh_Diffuse127 = tex2DNode123;
				float4 tex2DNode76 = tex2D( _Albedo_Smoothness, TexCoord169 );
...
Node;AmplifyShaderEditor.CommentaryNode;51;-616.5673,-376.7585;Inherit;False;531.663;304;Cut - Blood paints under cut, make sure cutmask is slightly smaller;3;144;143;142;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;52;-3067.394,323.4416;Inherit;False;1150.118;450.8744;BloodMask;8;116;115;114;113;63;62;61;60;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;53;-3069.117,-222.7398;Inherit;False;1152.388;533.1783;CutMask;7;111;110;109;99;59;58;182;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;54;-3065.334,797.6063;Inherit;False;1142.78;572.1578;BruiseMask;9;101;100;80;68;67;66;65;64;56;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;56;-2810.833,1152.147;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;57;-2057.208,-551.4219;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;58;-2606.419,-179.7569;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;59;-2842.585,-77.22693;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;60;-2842.704,551.3503;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;62;-2606.733,469.657;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;65;-2544.583,1080.005;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;74;-2364.542,-559.2256;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;75;-2666.116,-555.8209;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;99;-2375.65,-179.4433;Inherit;True;2;0;FLOAT;0.8;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;142;-336.5883,-303.9285;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;1,1,1,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;85;-576.7881,158.2286;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;86;-351.2708,41.50065;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;88;-190.9843,42.52885;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;131;-1517.129,3.957063;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;132;-1790.625,-65.86808;Inherit;False;ase_function_bloodcolor;-1;;2;439e2ac262e7b8a4db20b11e6f95045c;0;0;2;COLOR;0;COLOR;3
Node;AmplifyShaderEditor.SimpleAddOpNode;136;-1328.387,-66.34058;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;133;-1765.82,58.43068;Inherit;False;112;BloodWet;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;143;-586.684,-212.1307;Inherit;False;111;CutMaskLerp;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;144;-562.2315,-334.2755;Inherit;False;127;Flesh Diffuse;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;87;-639.0888,41.13297;Inherit;False;126;FleshSmoothness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;83;-865.2611,73.00092;Inherit;False;78;Smoothness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;98;-609.2289,308.0083;Inherit;False;111;CutMaskLerp;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;111;-2123.125,-179.0027;Inherit;False;CutMaskLerp;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;109;-3059.342,-180.5428;Inherit;False;95;Cut;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;146;310.4407,-300.0666;Float;False;True;-1;2;ASEMaterialInspector;0;4;Cortopia/_LowEnd/ase_character_lowend;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;18;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;2;Include;;False;;Native;False;0;0;;Include;../skinned_vertices_with_color.cginc;False;;Custom;False;0;0;;;0;0;Standard;40;Workflow,InvertActionOnDeselection;1;0;Surface;0;0;  Blend;0;0;  Refraction Model;0;0;  Dither Shadows;1;0;Two Sided;1;0;Deferred Pass;0;638524977965553134;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;638524978949071362;Built-in Fog;0;638524978954243093;Ambient Light;1;0;Meta Pass;1;0;Add Pass;0;638524979000042672;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Fwd Specular Highlights Toggle;0;0;Fwd Reflections Toggle;0;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;0;638423007020048860;0;6;False;True;False;False;True;True;False;;False;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;170;225.4984,-677.2077;Inherit;False;SkinnedTangent;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;171;236.4839,-832.8692;Inherit;False;SkinnedNormal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;172;281.126,-989.2297;Inherit;False;SkinnedPosition;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TangentVertexDataNode;174;8.611291,-686.3495;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NormalVertexDataNode;175;22.09335,-844.8172;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PosVertexDataNode;176;20.09786,-1012.167;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;173;10.56905,-527.945;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;162;31.66376,-110.633;Inherit;False;172;SkinnedPosition;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;164;31.51166,-41.05704;Inherit;False;171;SkinnedNormal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;163;32.37897,32.26957;Inherit;False;170;SkinnedTangent;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;165;-4070.134,-427.0233;Inherit;False;169;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;177;-3939.267,-677.7584;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;166;-4110.834,-21.5233;Inherit;False;169;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;179;-3926.056,38.04663;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;180;-4072.513,86.30243;Inherit;False;Constant;_Float1;Float 0;13;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;178;-4096.724,-659.5026;Inherit;False;Constant;_Float0;Float 0;13;0;Create;True;0;0;0;False;0;False;20;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;115;-1940.492,481.9737;Inherit;False;BloodLerp;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;63;-2104.488,438.4566;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;183;-2382.575,578.6107;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.7;False;2;FLOAT;0.9;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;61;-2367.124,364.5721;Inherit;True;2;0;FLOAT;0.91;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;169;283.518,-526.4151;Inherit;False;TexCoord;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;101;-3006.958,1225.316;Inherit;False;Constant;_BruiseStrenght;BruiseStrenght;6;0;Create;True;0;0;0;False;0;False;1.74;1.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;68;-2485.768,862.4484;Inherit;False;Constant;_BruiseColor;BruiseColor;4;0;Create;True;0;0;0;False;0;False;0.7529412,0.2705882,0,0;0.3686274,0.207843,0.6039216,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;182;-2563.963,86.2875;Inherit;False;Constant;_CutStep;CutStep;8;0;Create;True;0;0;0;False;0;False;0.86;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;184;-1154.98,-2.96759;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.97;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;134;-1446.733,135.7217;Inherit;False;115;BloodLerp;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;82;-1050.283,177.3199;Inherit;False;112;BloodWet;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;185;-826.9805,284.0324;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.7;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;186;-1086.85,313.5262;Inherit;False;93;BloodDry;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;168;-3973.736,264.1769;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;167;-4176.535,222.5768;Inherit;False;169;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;108;-4193.285,310.0167;Inherit;False;Constant;_BruiseTiling;BruiseTiling;8;0;Create;True;0;0;0;False;0;False;20,20;20,20;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;189;-3977.406,481.6696;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;190;-4180.205,440.0695;Inherit;False;169;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;192;-4177.328,530.5705;Inherit;False;Constant;_Float2;Float 2;7;0;Create;True;0;0;0;False;0;False;30;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;188;-3765.133,481.1975;Inherit;True;Property;_TextureSample2;Texture Sample 1;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;73;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;187;-3430.528,504.0079;Inherit;False;CutsBreakupMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;110;-3060.433,-31.83481;Inherit;False;187;CutsBreakupMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;114;-2592.384,384.1518;Inherit;False;Constant;_BloodNoise;BloodNoise;5;0;Create;True;0;0;0;False;0;False;0.7;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;193;-19.97011,-225.1873;Inherit;False;ase_function_telekinesis;5;;4;2b3f0b540b332bd4fbb2418f6d292683;0;0;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;81;-824.7745,179.571;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.95;False;1;FLOAT;0
...
WireConnection;97;1;165;0
WireConnection;99;0;58;0
WireConnection;99;1;182;0
