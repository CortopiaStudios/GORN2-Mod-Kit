...
Shader "Cortopia/_LowEnd/ase_creature_lowend"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			uniform float4 _BreakUpNoise_ST;
				...
				) : SV_Target
			{
				...
				float4 color1_g3 = IsGammaSpace() ? float4(0.6226415,0.1795018,0.1204165,0) : float4(0.3456162,0.02707354,0.01348848,0);
				...
				float4 color2_g3 = IsGammaSpace() ? float4(0.5188679,0.06118724,0.07892682,0) : float4(0.2319225,0.005018505,0.007057911,0);
				float2 uv_BreakUpNoise = IN.ase_texcoord9.xy * _BreakUpNoise_ST.xy + _BreakUpNoise_ST.zw;
				float temp_output_70_0 = ( tex2DNode80.r + ( tex2DNode80.r * tex2D( _BreakUpNoise, uv_BreakUpNoise ).r ) );
		...
		Pass
		{
			...
			)
			{
				...
				float4 tex2DNode80 = tex2D( _MaskTexture, uv_MaskTexture );
				float4 color2_g3 = IsGammaSpace() ? float4(0.5188679,0.06118724,0.07892682,0) : float4(0.2319225,0.005018505,0.007057911,0);
				float2 uv_BreakUpNoise = IN.ase_texcoord8.xy * _BreakUpNoise_ST.xy + _BreakUpNoise_ST.zw;
				float temp_output_70_0 = ( tex2DNode80.r + ( tex2DNode80.r * tex2D( _BreakUpNoise, uv_BreakUpNoise ).r ) );
				float temp_output_74_0 = step( 0.75 , temp_output_70_0 );
				float4 lerpResult88 = lerp( tex2DNode72 , ( ( color1_g3 * tex2DNode80.r ) + ( color2_g3 * tex2DNode80.a ) ) , temp_output_74_0);
				float4 temp_output_10_0_g7 = lerpResult88;
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 tex2DNode80 = tex2D( _MaskTexture, uv_MaskTexture );
				float4 color2_g3 = IsGammaSpace() ? float4(0.5188679,0.06118724,0.07892682,0) : float4(0.2319225,0.005018505,0.007057911,0);
				float2 uv_BreakUpNoise = IN.ase_texcoord3.xy * _BreakUpNoise_ST.xy + _BreakUpNoise_ST.zw;
				float temp_output_70_0 = ( tex2DNode80.r + ( tex2DNode80.r * tex2D( _BreakUpNoise, uv_BreakUpNoise ).r ) );
				float temp_output_74_0 = step( 0.75 , temp_output_70_0 );
				float4 lerpResult88 = lerp( tex2DNode72 , ( ( color1_g3 * tex2DNode80.r ) + ( color2_g3 * tex2DNode80.a ) ) , temp_output_74_0);
				float4 temp_output_10_0_g7 = lerpResult88;
...
Node;AmplifyShaderEditor.SamplerNode;71;-1730.756,243.3628;Inherit;True;Property;_BreakUpNoise;BreakUpNoise;1;0;Create;True;0;0;0;False;0;False;-1;None;5657507ec4511ef43a15e0e101373dad;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-1042.505,65.21468;Inherit;False;Constant;_BloodNoise;BloodNoise;6;0;Create;True;0;0;0;False;0;False;0.75;0.35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;95;500.684,-282.1075;Float;False;True;-1;2;ASEMaterialInspector;0;4;Cortopia/_LowEnd/ase_creature_lowend;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;18;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;2;Include;;False;;Native;False;0;0;;Include;../skinned_vertices_with_color.cginc;False;;Custom;False;0;0;;;0;0;Standard;40;Workflow,InvertActionOnDeselection;1;0;Surface;0;0;  Blend;0;0;  Refraction Model;0;0;  Dither Shadows;1;0;Two Sided;1;0;Deferred Pass;1;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Ambient Light;1;0;Meta Pass;1;0;Add Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Fwd Specular Highlights Toggle;0;0;Fwd Reflections Toggle;0;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;0;638524894639113699;0;6;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=6B0F69DD7ECB540C04E3445FC048DC4E3B6971E5