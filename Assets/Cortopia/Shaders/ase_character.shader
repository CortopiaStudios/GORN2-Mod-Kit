...
Shader "Cortopia/ase_character"
{
	Properties
	{
		...
		_BloodNoise("BloodNoise", Float) = 0.7
	...
	LOD 0
		...
		Pass
		{
			...
			v2f VertexFunction (appdata v  ) {
				...
				float3 SkinnedPosition207 = v.vertex.xyz;
				
				float3 SkinnedNormal209 = v.normal;
				
				float3 SkinnedTangent210 = v.tangent.xyz;
				...
				v.tangent = float4( SkinnedTangent210 , 0.0 );
				...
				) : SV_Target
			{
				...
				float2 texCoord219 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 TexCoord200 = texCoord219;
				...
				float temp_output_83_0 = ( BloodDry128 + ( BloodDry128 * BloodEdgeMask71 ) );
				float BloodLerp129 = saturate( step( _BloodNoise , temp_output_83_0 ) );
				float clampResult248 = clamp( BloodLerp129 , 0.0 , 0.97 );
				float4 lerpResult105 = lerp( lerpResult114 , ( color1_g2 + ( color2_g2 * BloodWet125 ) ) , clampResult248);
				float CutsBreakupMask241 = tex2D( _BloodCutBruiseMask, ( TexCoord200 * 30.0 ) ).r;
				float CutMaskLerp116 = step( ( Cut127 + ( Cut127 * CutsBreakupMask241 ) ) , 0.86 );
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float2 texCoord219 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 TexCoord200 = texCoord219;
				float4 tex2DNode61 = tex2D( _MaskTexture, TexCoord200 );
				float Cut127 = tex2DNode61.g;
...
Node;AmplifyShaderEditor.CommentaryNode;53;-2612.452,-75.28753;Inherit;False;1152.388;533.1783;CutMask;7;117;116;70;69;68;67;247;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;150;-150.0663,412.4722;Inherit;False;151;FleshSmoothness;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;152;-115.2791,676.0629;Inherit;False;116;CutMaskLerp;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;124;-2135.719,531.6041;Inherit;False;Property;_BloodNoise;BloodNoise;7;0;Create;True;0;0;0;False;0;False;0.7;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;219;736.2761,-458.9463;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;200;1009.225,-457.4164;Inherit;False;TexCoord;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TangentVertexDataNode;222;734.3183,-617.3508;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;210;951.2053,-608.209;Inherit;False;SkinnedTangent;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NormalVertexDataNode;221;747.8004,-775.8185;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;209;962.1908,-763.8704;Inherit;False;SkinnedNormal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PosVertexDataNode;220;745.8049,-943.1692;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;207;1006.833,-920.2316;Inherit;False;SkinnedPosition;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;229;-3670.002,256.7259;Inherit;False;Constant;_Float1;Float 1;13;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;82;-1912.677,511.0142;Inherit;False;2;0;FLOAT;0.91;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-2550.293,1372.768;Inherit;False;Constant;_BruiseStrenght;BruiseStrenght;8;0;Create;True;0;0;0;False;0;False;1.74;1.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;240;-1918.089,722.9504;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.7;False;2;FLOAT;0.9;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;237;-3519.273,-23.22962;Inherit;False;200;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;60;-4256.007,-657.9745;Inherit;False;Constant;_ParallaxHeight;ParallaxHeight;8;0;Create;True;0;0;0;False;0;False;-0.2;-0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;117;-1918.985,-31.99102;Inherit;True;2;0;FLOAT;0.8;False;1;FLOAT;0.9;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;184;1082.238,-154.9338;Float;False;True;-1;2;ASEMaterialInspector;0;4;Cortopia/ase_character;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;18;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;2;Include;;False;;Native;False;0;0;;Include;skinned_vertices_with_color.cginc;False;;Custom;False;0;0;;;0;0;Standard;40;Workflow,InvertActionOnDeselection;1;0;Surface;0;0;  Blend;0;0;  Refraction Model;0;0;  Dither Shadows;1;0;Two Sided;1;0;Deferred Pass;0;638524980939577773;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;638524981043317106;Built-in Fog;0;638524981051768050;Ambient Light;1;0;Meta Pass;1;0;Add Pass;0;638524981087028881;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Fwd Specular Highlights Toggle;0;0;Fwd Reflections Toggle;0;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;0;638386822356192945;0;6;False;True;False;False;True;True;False;;False;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;242;-3543.945,616.6306;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;243;-3743.49,581.5941;Inherit;False;200;TexCoord;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;245;-3304.186,617.5146;Inherit;True;Property;_TextureSample2;Texture Sample 1;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;123;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;246;-3718.061,666.583;Inherit;False;Constant;_Float2;Float 2;7;0;Create;True;0;0;0;False;0;False;30;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;70;-2603.767,115.6175;Inherit;False;241;CutsBreakupMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;241;-2974.643,642.0999;Inherit;False;CutsBreakupMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;247;-2117.398,241.4412;Inherit;False;Constant;_CutStepMin;CutStepMin;6;0;Create;True;0;0;0;False;0;False;0.86;0.87;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;102;-786.6172,220.3208;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;109;-1061.517,326.6969;Inherit;False;79;Diffuse;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;248;-624.7551,103.2128;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.97;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;99;-811.9508,333.1894;Inherit;False;129;BloodLerp;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;211;559.3354,470.9414;Inherit;False;207;SkinnedPosition;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;213;560.0506,613.8431;Inherit;False;210;SkinnedTangent;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;212;559.1833,540.5171;Inherit;False;209;SkinnedNormal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;145;417.5309,260.7382;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;138;-587.7676,708.7169;Inherit;False;128;BloodDry;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;249;-331.3033,665.0955;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.75;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;252;623.8223,-90.92606;Inherit;False;ase_function_telekinesis;8;;4;2b3f0b540b332bd4fbb2418f6d292683;0;0;1;COLOR;0
...
WireConnection;117;1;247;0
WireConnection;184;0;103;0
WireConnection;184;1;156;0
WireConnection;184;2;252;0
